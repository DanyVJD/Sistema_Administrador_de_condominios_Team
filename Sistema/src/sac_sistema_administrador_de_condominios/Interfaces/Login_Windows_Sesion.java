...
import Controllers.ControlladorSession;
 ...
 * @author Dany-PC
 */
public class Login_Windows_Sesion extends javax.swing.JFrame {
     ...
     * @param mysql
     */
    public Login_Windows_Sesion(MySQL mysql) {
        initComponents();
        this.mysql = mysql;
    ...
    public void controller(ControlladorSession event) {
